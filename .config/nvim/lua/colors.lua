...
cmd("hi! link NvimTreeNormal Normal")
cmd("hi! link NvimTreeRootFolder FgPaleBlue")

-- gutter
cmd("hi! link GitSignsAdd LightGrayOnDarkGray")
cmd("hi! link GitSignsChange LightGrayOnDarkGray")
cmd("hi! link GitSignsDelete LightGrayOnDarkGray")
